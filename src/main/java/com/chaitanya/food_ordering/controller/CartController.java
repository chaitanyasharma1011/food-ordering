...
public class CartController {
    ...
    @PutMapping("/clear")
    public ResponseEntity<Cart> updateQuantity(@RequestHeader("Authorisation") String jwt)
            throws Exception{
    ...
    @GetMapping
    public ResponseEntity<Cart> fetchcartItems(@RequestHeader("Authorisation") String jwt)
            throws Exception{
